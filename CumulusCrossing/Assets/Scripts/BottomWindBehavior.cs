...
// THIS SCRIPT DEFINES THE BEHAVIOR OF THE GUSTS OF WIND THAT THE PLAYER CONTROLLER'S BOTTOM CLOUD SHOOTS

public class BottomWindBehavior : MonoBehaviour
{
    // Defining variables
    Rigidbody2D rb;
    ...
    private void OnTriggerEnter2D(Collider2D other)
    {
        ...
        {
            Debug.Log("Bottom wind hit airship.");
